...
신입 사원이 들어와서 사원 테이블에 추가한다.

```sql
INSERT INTO 사원 (사원번호, 이름, 주소, 부서) [ ① ] (32431, '정실기', '서울', '영업');
```

위의 신입사원을 검색하면서 부서 테이블에 추가한다.
...
- 기업에서 사설 인터넷망으로 사용할 수 있는 VPN을 구현하는 데 사용되는 프로토콜이다.
...
아래는 소프트웨어 설계에 대한 내용이다. 내용을 읽고 괄호 안에 알맞는 답을 작성하시오.
